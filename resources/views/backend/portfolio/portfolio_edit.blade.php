        ...
        <div class="col-xl-8 m-auto">
          <div class="form-layout form-layout-4">
            ...
            <div class="row mg-t-20">
              ...
              <div class="row mg-t-20">
                <label class="col-sm-3 form-control-label">Portfolio Link: <span class="tx-danger">*</span></label>
                <div class="col-sm-9 mg-t-10 mg-sm-t-0">
                  <input type="text" name="portfolio_link" class="form-control" value="{{ $portfolio->portfolio_link }}">
                </div>
              </div>
            <div class="row mg-t-20">
                <label class="col-sm-3 form-control-label">Portfolio Thumbnail: <span class="tx-danger">*</span></label>
                <div class="col-sm-9 mg-t-10 mg-sm-t-0">
                  <input type="file" name="thumbnail" class="form-control">
                </div>
              </div>
              <div class="row mg-t-20">
                <label class="col-sm-3 form-control-label">Portfolio Image: <span class="tx-danger">*</span></label>
                <div class="col-sm-9 mg-t-10 mg-sm-t-0">
...
@section('footer_js')
  <script src="https://cdn.jsdelivr.net/npm/sweetalert2@10"></script>
    ...
    <script>
        ...
        @if(session('PortfolioUpdate'))
            Swal.fire({
                position: 'center',
                icon: 'success',
                title: 'Portfolio Update Successfully',
                showConfirmButton: false,
                timer: 1000
            })
        @endif
