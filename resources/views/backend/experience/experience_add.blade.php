          ...
          <div class="form-layout form-layout-4">
            ...
            <div class="row mg-t-20">
              ...
              <div class="col-sm-9 mg-t-10 mg-sm-t-0">
                <input type="text" name="times" class="form-control" placeholder="Enter Service Name">
              </div>
            </div>
            <div class="row mg-t-20">
                <label class="col-sm-3 form-control-label">Position: <span class="tx-danger">*</span></label>
                <div class="col-sm-9 mg-t-10 mg-sm-t-0">
                  <input type="text" name="position" class="form-control" placeholder="Enter Service Name">
                </div>
              </div>
            <div class="row mg-t-20">
