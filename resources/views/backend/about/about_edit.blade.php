        ...
        <div class="col-xl-8 m-auto">
          <div class="form-layout form-layout-4">
            ...
            <div class="row mg-t-20">
                <input type="hidden" class="form-control" name="about_id" value="{{ $aboutus->id }}">
              <label class="col-sm-3 form-control-label">Position: <span class="tx-danger">*</span></label>
              <div class="col-sm-9 mg-t-10 mg-sm-t-0">
                <input type="text" name="position" class="form-control" value="{{ $aboutus->position }}" placeholder="Enter Position Name">
              </div>
            ...
            <div class="row mg-t-20">
              ...
              <div class="col-sm-9 mg-t-10 mg-sm-t-0">
                <textarea name="description" placeholder="Enter description" class="form-control">{{ $aboutus->description }}</textarea>
              </div>
            </div>
            <div class="row mg-t-20">
